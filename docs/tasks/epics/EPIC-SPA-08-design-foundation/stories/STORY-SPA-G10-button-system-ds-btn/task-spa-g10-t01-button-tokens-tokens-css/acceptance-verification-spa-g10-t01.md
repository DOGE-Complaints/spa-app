# Acceptance verification — SPA-G10-T01

- **Task:** Button tokens in tokens.css
- **Result:** PASS
...
```bash
rg -n 'control-height|button-primary|btn-on-primary' spa-app/src/styles/tokens.css | head
```
