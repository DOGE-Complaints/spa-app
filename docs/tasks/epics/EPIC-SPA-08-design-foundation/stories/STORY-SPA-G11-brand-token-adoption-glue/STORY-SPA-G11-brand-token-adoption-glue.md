...
- **Epic:** EPIC-SPA-08 Design Foundation · Wave 5 (Brand token adoption / glue)
...
- **source:** [`spa-app/docs/tasks/backlog-stories/design-foundation/STORY-SPA-G11-brand-token-adoption-glue.md`](../../../../backlog-stories/design-foundation/STORY-SPA-G11-brand-token-adoption-glue.md)
- **decision_ref:** [`../../../../backlog-stories/design-foundation/STORY-SPA-G11-brand-token-adoption-glue.md`](../../../../backlog-stories/design-foundation/STORY-SPA-G11-brand-token-adoption-glue.md); [reaudit F3–F8](../../../../../analysis/reaudit-STORY-SPA-G9-gap-closure-2026-08-02.md); [DOGEstonia_Color_Palette_v1.0_RU.md](../../../../backlog-stories/design-foundation/DOGEstonia_Color_Palette_v1.0_RU.md); [`tokens.css`](../../../../../../src/styles/tokens.css); G9 Done [`STORY-SPA-G9-brand-color-palette-tokens.md`](../../../../backlog-stories/design-foundation/STORY-SPA-G9-brand-color-palette-tokens.md) (`pkg-000042`)
- **ui_scope:** `none`
- **Gate:** [acceptance-verification-spa-g11.md](./task-spa-g11-t11-story-gate-g11/acceptance-verification-spa-g11.md)
- **Зависит от:** [G9 Brand color palette](../../../../backlog-stories/design-foundation/STORY-SPA-G9-brand-color-palette-tokens.md) **Done** (`pkg-000042`) — G9 **не reopen**
- **Координирует:** [G10 Button system](../../../../backlog-stories/design-foundation/STORY-SPA-G10-button-system-ds-btn.md) — Wave 1 (`accent-hover` / ink) желательно до или вместе с Button foundation; G11 **не** блокирует G10

## SSOT дизайна

| Слой | Артефакт | Роль |
|------|----------|------|
| Brand hex / `--doge-*` | [Color Palette v1.0](../../../../backlog-stories/design-foundation/DOGEstonia_Color_Palette_v1.0_RU.md) §2–§6 | Утверждённые цвета |
...
| Parent cutover | [STORY-SPA-G9](../../../../backlog-stories/design-foundation/STORY-SPA-G9-brand-color-palette-tokens.md) | Done — canvas/accent; leftovers → **this story** |
...
| ID | Sev | Суть | Класс |
|----|-----|------|-------|
| **F3** | Low | [G9 backlog](../../../../backlog-stories/design-foundation/STORY-SPA-G9-brand-color-palette-tokens.md) §Зачем / §анализ всё ещё «уголь + жёлтый» / «0 hits `--doge-*`» | Doc hygiene |
| **F4** | Low | [G4](../../../../backlog-stories/design-foundation/STORY-SPA-G4-design-tokens-foundation.md) «Вне scope» — `G9 … (Todo)` при Meta note Done `pkg-000042` | Doc hygiene |
...
| Таск | Волна | Folder | Суть |
|------|-------|--------|------|
| **T01** | 0 | [task-spa-g11-t01-sync-g9-backlog-historical-wording](./task-spa-g11-t01-sync-g9-backlog-historical-wording/README.md) | F3: G9 backlog §Зачем + §анализ → historical / post-Done wording |
| **T02** | 0 | [task-spa-g11-t02-sync-g4-g9-scope-done](./task-spa-g11-t02-sync-g4-g9-scope-done/README.md) | F4: G4 «Вне scope» G9 `(Todo)` → Done |
| **T03** | 0 | [task-spa-g11-t03-color-palette-implemented-touchpoint](./task-spa-g11-t03-color-palette-implemented-touchpoint/README.md) | F5: Color Palette Meta + implemented touchpoint |
| **T04** | 1 | [task-spa-g11-t04-cta-accent-hover-and-ink-unify](./task-spa-g11-t04-cta-accent-hover-and-ink-unify/README.md) | Wire CTA `:hover` accent-hover; unify ink/bg label |
| **T05** | 1 | [task-spa-g11-t05-soft-accent-fills-and-alias](./task-spa-g11-t05-soft-accent-fills-and-alias/README.md) | Soft fills → `--doge-accent-soft`; optional `--color-accent-soft` |
| **T06** | 1 | [task-spa-g11-t06-text-warm-spot-and-ds-note](./task-spa-g11-t06-text-warm-spot-and-ds-note/README.md) | Spot `--color-text-warm`; design-system Do/Don't |
| **T07** | 2 | [task-spa-g11-t07-statusbadge-hex-to-surface-tokens](./task-spa-g11-t07-statusbadge-hex-to-surface-tokens/README.md) | StatusBadge hex → surface / border / accent-soft |
| **T08** | 3 | [task-spa-g11-t08-rgba-pack-cabinet](./task-spa-g11-t08-rgba-pack-cabinet/README.md) | RGBA pack A — cabinet |
| **T09** | 3 | [task-spa-g11-t09-rgba-pack-auth-identity](./task-spa-g11-t09-rgba-pack-auth-identity/README.md) | RGBA pack B — auth/identity |
| **T10** | 3 | [task-spa-g11-t10-rgba-pack-board-chrome](./task-spa-g11-t10-rgba-pack-board-chrome/README.md) | RGBA pack C — board/chrome |
| **T11** | 4 | [task-spa-g11-t11-story-gate-g11](./task-spa-g11-t11-story-gate-g11/README.md) | Inventory gate + vitest + INDEX/reaudit + story acceptance |
...
## Вне scope
- Полный DS-BTN / `Button.jsx` ([G10](../../../../backlog-stories/design-foundation/STORY-SPA-G10-button-system-ds-btn.md))
...
- Execute кода в **docs-intake** шаге (только story + indexes) — **P1 scaffold only**; execute = P3

## Documentation touchpoints (при закрытии execute)

| Файл | Действие |
|------|----------|
| [STORY-SPA-G9…](../../../../backlog-stories/design-foundation/STORY-SPA-G9-brand-color-palette-tokens.md) | Historical wording (Wave 0); Meta pointer G11 |
| [STORY-SPA-G4…](../../../../backlog-stories/design-foundation/STORY-SPA-G4-design-tokens-foundation.md) | Вне scope G9 Done |
| [Color Palette](../../../../backlog-stories/design-foundation/DOGEstonia_Color_Palette_v1.0_RU.md) | Implemented touchpoint |
...
| [INDEX.md](../../../../backlog-stories/INDEX.md) / spa-mvp-dashboard | G11 Todo → Done |
