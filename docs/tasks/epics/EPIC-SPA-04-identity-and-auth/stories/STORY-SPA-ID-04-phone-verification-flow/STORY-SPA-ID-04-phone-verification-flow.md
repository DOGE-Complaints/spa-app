...
- **Status:** Done (pkg-000018, 2026-06-28)
- **Wave:** `pkg-000018`
- **source:** [`spa-app/docs/tasks/backlog-stories/identity-auth/STORY-SPA-ID-04-phone-verification-flow.md`](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-04-phone-verification-flow.md)
- **Decision Ref:** [`../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-04-phone-verification-flow.md`](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-04-phone-verification-flow.md); [identity-frontend FR-FE-004 / S4 / §3](../../../../../../../docs/Identity/identity-frontend.md); [mockup-32](../../../../../../UX/mockups/epic-04/mockup-32-phone-verification-flow-sheet-spec.md); [DOC-IDS-ONB-02](../../../../../../../doge-identity-service/docs/tasks/backlog-stories/identity-onboarding/DOC-IDS-ONB-02-disclosure-copy.md)
- **Источник:** [epic-04 S04-3](../../../../../../backlog-stories/inbound/epic-04.md), [identity-frontend FR-FE-004 / S4 / §3](../../../../../../../docs/Identity/identity-frontend.md)
...
## Зависимости
- Отображает фазу через [ID-03](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-03-civic-status-component.md). Ошибки flow — в [ID-05](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-05-verification-error-states.md). Используется гейтом [ID-06](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-06-protected-action-gate.md) и [ID-08](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-08-gpt-verification-entry.md).

## Вне scope
- Конкретные error-состояния (ID-05). Сохранение/резюм story-draft (ID-06). eID/wallet.

## Acceptance Criteria (FR-уровень)
- [x] Disclosure показан ДО ввода номера; тон дружелюбный; запрещённые термины не используются.
- [x] Полный happy-path: номер → код → confirm → success, без ухода из SPA.
- [x] Resend доступен после cooldown 60s с таймером; OTP-поле `one-time-code`.
- [x] После success — refresh `/me` и возврат к прерванному действию.
- [x] При `phone_verified=true` повторно верифицировать не просят.

## Nested tasks

| Order | Task folder | Wave |
|---|---|---|
| 1 | [`task-spa-id-04-t01-phone-api-verification-flow-state`](./task-spa-id-04-t01-phone-api-verification-flow-state/README.md) | pkg-000018 |
| 2 | [`task-spa-id-04-t02-phone-verification-flow-shell-m32`](./task-spa-id-04-t02-phone-verification-flow-shell-m32/README.md) | pkg-000018 |
| 3 | [`task-spa-id-04-t03-disclosure-phone-input-states-ab`](./task-spa-id-04-t03-disclosure-phone-input-states-ab/README.md) | pkg-000018 |
| 4 | [`task-spa-id-04-t04-otp-processing-success-states-cde`](./task-spa-id-04-t04-otp-processing-success-states-cde/README.md) | pkg-000018 |
| 5 | [`task-spa-id-04-t05-verify-route-flow-integration`](./task-spa-id-04-t05-verify-route-flow-integration/README.md) | pkg-000018 |
| 6 | [`task-spa-id-04-t06-tests-phone-verification-vitest`](./task-spa-id-04-t06-tests-phone-verification-vitest/README.md) | pkg-000018 |
| 7 | [`task-spa-id-04-t07-story-gate-id-04`](./task-spa-id-04-t07-story-gate-id-04/README.md) | pkg-000018 |
