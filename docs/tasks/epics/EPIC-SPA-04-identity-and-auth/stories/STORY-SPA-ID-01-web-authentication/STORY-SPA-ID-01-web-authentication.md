...
- **Status:** Done
- **Wave:** `pkg-000013`
- **source:** [`spa-app/docs/tasks/backlog-stories/identity-auth/STORY-SPA-ID-01-web-authentication.md`](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-01-web-authentication.md)
- **Decision Ref:** [`../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-01-web-authentication.md`](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-01-web-authentication.md); [epic-04 S04-1](../../../../../../backlog-stories/inbound/epic-04.md); [identity-frontend FR-FE-001 / S1](../../../../../../../docs/Identity/identity-frontend.md); [mockup-121](../../../../../../UX/mockups/epic-04/mockup-121-web-authentication-state-sheet-spec.md); [`me_response.py`](../../../../../../../doge-identity-service/src/core/api/me_response.py)
- **Источник:** [epic-04 S04-1](../../../../../../backlog-stories/inbound/epic-04.md), [identity-frontend FR-FE-001 / S1](../../../../../../../docs/Identity/identity-frontend.md)
...
## Зависимости
- Нет входящих. Фундамент для всех ID-0x. Сессионные shell-состояния — в [ID-02](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-02-session-shell-states.md). Переход после GPT-входа (`oauth_request_id`) — в [ID-08](../../../../../../backlog-stories/identity-auth/STORY-SPA-ID-08-gpt-verification-entry.md).

## Вне scope
- Story-draft контекст (это GPT/gate — ID-06/08). Phone verify (ID-04). OAuth-выдача кода (ID-08).

## Acceptance Criteria (FR-уровень)
- [x] Login/signup по email работают до доступа к dashboard; телефон при signup не запрашивается.
- [x] Magic-link и forgot-password имеют свои состояния (sent / reset-requested).
- [x] 5 auth-ошибок различимы и не generic (особенно `invalid_credentials`).
- [x] Success ведёт на целевой роут; сессия восстановима.
- [x] Экран без story-draft/GPT-контекста (автономный веб-вход).

## Nested tasks

| Order | Task folder | Wave |
|---|---|---|
| 1 | [`task-spa-id-01-t01-env-deps-supabase-client`](./task-spa-id-01-t01-env-deps-supabase-client/README.md) | pkg-000013 |
| 2 | [`task-spa-id-01-t02-identity-api-me-client`](./task-spa-id-01-t02-identity-api-me-client/README.md) | pkg-000013 |
| 3 | [`task-spa-id-01-t03-login-route-page-shell`](./task-spa-id-01-t03-login-route-page-shell/README.md) | pkg-000013 |
| 4 | [`task-spa-id-01-t04-login-signup-password-flows`](./task-spa-id-01-t04-login-signup-password-flows/README.md) | pkg-000013 |
| 5 | [`task-spa-id-01-t05-magic-link-forgot-password`](./task-spa-id-01-t05-magic-link-forgot-password/README.md) | pkg-000013 |
| 6 | [`task-spa-id-01-t06-auth-errors-success-redirect`](./task-spa-id-01-t06-auth-errors-success-redirect/README.md) | pkg-000013 |
| 7 | [`task-spa-id-01-t07-tests-auth-vitest-puppeteer`](./task-spa-id-01-t07-tests-auth-vitest-puppeteer/README.md) | pkg-000013 |
| 8 | [`task-spa-id-01-t08-story-gate-id-01`](./task-spa-id-01-t08-story-gate-id-01/README.md) | pkg-000013 |
| 9 | [`task-spa-id-01-t09-remember-me-persist-session`](./task-spa-id-01-t09-remember-me-persist-session/README.md) | run_mode post-audit |
| 10 | [`task-spa-id-01-t10-success-destination-link-alignment`](./task-spa-id-01-t10-success-destination-link-alignment/README.md) | run_mode post-audit |
| 11 | [`task-spa-id-01-t11-signup-password-mismatch-message`](./task-spa-id-01-t11-signup-password-mismatch-message/README.md) | run_mode post-audit |
