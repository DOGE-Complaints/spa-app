# STORY-SPA-PH-05 — How It Works Page
...
- **Pipeline:** [pipeline story](../../epics/EPIC-SPA-09-public-shell-home/stories/STORY-SPA-PH-05-how-it-works-page/STORY-SPA-PH-05-how-it-works-page.md)
- **Package:** [public-home/](README.md) · [PRODUCT-BRIEF.md](PRODUCT-BRIEF.md) · [UX-PROMPTS.md](UX-PROMPTS.md) (PH-T) · active pipeline pkg `pkg-000050`
- **Status:** Done — P3 gate PASS 2026-08-04T13:22:05Z (`pkg-000050`)
- **Severity:** 🟡 MED
- **Depends on:** [M133](../../../UX/mockups/home/mockup-133-public-how-it-works-page-state-sheet-spec.md); [L10N appendix](../../../UX/mockups/home/mockup-133-public-how-it-works-localized-copy-appendix.md); [api-req §3.1](STORY-SPA-PH-api-requirements.md); PH-01 chrome; PH-06 for Submit CTA
...
- **As-of-Done (P3 `pkg-000050`):** [`HowItWorksPage.jsx`](../../../../src/pages/HowItWorksPage.jsx) — full M133 tutorial; route in [`App.jsx`](../../../../src/App.jsx) ✅.
- Copy SSOT = M133 appendix (`howItWorks.*`) in [`howItWorksDictionary.js`](../../../../src/i18n/howItWorksDictionary.js).
- API/CMS: none ✅ — static i18n only.
...
| Таск | Суть | Швы |
|------|------|-----|
| **T01** | Add route `/how-it-works` + page component | [`App.jsx`](../../../../src/App.jsx) |
| **T02** | Four-step layout per M133 | new page |
| **T03** | Wire CTAs: `/board` + PH-06 submit helper | PH-06 |
| **T04** | Step icons reuse (doc/summary); opt chevron | icon catalog |
| **T05** | L10N full `howItWorks.*` from appendix | `publicHomeDictionary.js` |
| **T06** | Vitest: route public; 4 steps; CTA targets; key parity | `__tests__` |
| **T07** | Story gate PH-05 | — |
...
## Routes / API
- [api-req §3.1](STORY-SPA-PH-api-requirements.md): static i18n; **no CMS**.
- Public route — not protected (no session overlay required for read).

## Зависимости
- PH-01 / PH-03 — chrome.
- PH-06 — Submit CTA env URL.
...
## Швы
- [`App.jsx`](../../../../src/App.jsx), new HowItWorks page, PH chrome, PH-06 submit helper, `publicHomeDictionary.js`.
