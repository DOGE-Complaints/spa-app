...
- **Status:** Done (pkg-000021, 2026-06-29)
- **Источник:** [epic-04 S04-5](../inbound/epic-04.md), [identity-frontend FR-FE-003/005/010 / S3](../../../../../docs/Identity/identity-frontend.md)
...
- **FR-06.4** Верификация — переиспользовать flow [ID-04](STORY-SPA-ID-04-phone-verification-flow.md) (не рисовать заново).
...
## Зависимости
- Зависит от [ID-04](STORY-SPA-ID-04-phone-verification-flow.md) (verify) и [ID-03](STORY-SPA-ID-03-civic-status-component.md) (статус). Draft-механика — у gateway (контракт story-drafts вне identity). GPT-вариант того же паттерна — [ID-08](STORY-SPA-ID-08-gpt-verification-entry.md).
